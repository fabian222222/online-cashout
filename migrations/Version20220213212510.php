 ...
 */
final class Version20220213212510 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_has_product CHANGE is_checked checked TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_has_product CHANGE checked is_checked TINYINT(1) NOT NULL');
    }
}
